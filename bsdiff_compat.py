...
- Cython: usa bsdiff_cython (.pyx) se disponível
- Desktop: usa bsdiff4 nativo se disponível
...
def _py_patch(src: bytes, patch_data: bytes) -> bytes:
...
def _py_diff(src: bytes, dst: bytes) -> bytes:
    """
